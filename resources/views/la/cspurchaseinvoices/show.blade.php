...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cspurchaseinvoice->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/cspurchaseinvoices/'.$cspurchaseinvoice->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cspurchaseinvoices.destroy', $cspurchaseinvoice->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cspurchaseinvoices') }}" data-toggle="tooltip" data-placement="right" title="Back to CsPurchaseInvoices"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'invoice_no')
						@la_display($module, 'date')
						@la_display($module, 'bill_no')
						@la_display($module, 'purchase_type')
						@la_display($module, 'suppliers')
						@la_display($module, 'item')
						@la_display($module, 'category')
						@la_display($module, 'unit')
						@la_display($module, 'quantity')
						@la_display($module, 'sub_quantity')
						@la_display($module, 'total_quantity')
						@la_display($module, 'Actual_price')
						@la_display($module, 'Purchase_price')
						@la_display($module, 'total_Purchase_price')
						@la_display($module, 'grans_total_price')
						@la_display($module, 'payment_status')
						@la_display($module, 'due_amount')
