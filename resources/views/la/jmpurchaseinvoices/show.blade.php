...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $jmpurchaseinvoice->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/jmpurchaseinvoices/'.$jmpurchaseinvoice->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jmpurchaseinvoices.destroy', $jmpurchaseinvoice->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/jmpurchaseinvoices') }}" data-toggle="tooltip" data-placement="right" title="Back to JMPurchaseInvoices"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'invoice_type')
						@la_display($module, 'date')
						@la_display($module, 'invoice_no')
						@la_display($module, 'supplier_id')
						@la_display($module, 'supplier_bill_id')
						@la_display($module, 'jute_receive_bill')
