...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $csgatepass->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/csgatepasses/'.$csgatepass->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.csgatepasses.destroy', $csgatepass->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/csgatepasses') }}" data-toggle="tooltip" data-placement="right" title="Back to CsGatePasses"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'do_lits')
						@la_display($module, 'date')
						@la_display($module, 'gp_no')
						@la_display($module, 'do_no')
						@la_display($module, 'sr_no')
						@la_display($module, 'do_quantity')
						@la_display($module, 'gp_quantity')
						@la_display($module, 'do_per_sacks_amount')
						@la_display($module, 'do_payment_amount')
						@la_display($module, 'do_payment_amount_paid')
						@la_display($module, 'do_payment_amount_due')
