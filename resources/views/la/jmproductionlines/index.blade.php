...
@section("contentheader_title", "JMProductionlines")
@section("contentheader_description", "jmproductionlines listing")
@section("section", "JMProductionlines")
@section("sub_section", "Listing")
@section("htmlheader_title", "JMProductionlines Listing")

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add JMProductionline</button>
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add JMProductionline</h4>
			</div>
			{!! Form::open(['action' => 'LA\JMProductionlinesController@store', 'id' => 'jmproductionline-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/jmproductionline_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#jmproductionline-add-form").validate({
