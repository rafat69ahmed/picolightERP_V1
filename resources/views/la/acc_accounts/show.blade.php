...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $acc_account->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/acc_accounts/'.$acc_account->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.acc_accounts.destroy', $acc_account->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/acc_accounts') }}" data-toggle="tooltip" data-placement="right" title="Back to Acc_accounts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'account_no')
						@la_display($module, 'account_title')
						@la_display($module, 'acc_or_group')
						@la_display($module, 'acc_depth')
						@la_display($module, 'nature')
						@la_display($module, 'account_status')
						@la_display($module, 'parent_id')
						@la_display($module, 'opening_balance')
						@la_display($module, 'current_balance')
						@la_display($module, 'is_inventory_related')
						@la_display($module, 'ledger_type_id')
						@la_display($module, 'ledger_id')
						@la_display($module, 'company_id')
						@la_display($module, 'user_id')
						@la_display($module, 'modified_date')
						@la_display($module, 'final_parent_id')
					</div>
				</div>
			</div>
		</div>
