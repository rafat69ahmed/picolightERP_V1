...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $acc_ledger->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/acc_ledgers/'.$acc_ledger->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.acc_ledgers.destroy', $acc_ledger->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/acc_ledgers') }}" data-toggle="tooltip" data-placement="right" title="Back to Acc_ledgers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'ledger_name')
						@la_display($module, 'ledger_type')
						@la_display($module, 'ledger_type_id')
						@la_display($module, 'address')
						@la_display($module, 'country_id')
						@la_display($module, 'currency_id')
						@la_display($module, 'contact_person')
						@la_display($module, 'bank_acc_type')
						@la_display($module, 'business_type')
