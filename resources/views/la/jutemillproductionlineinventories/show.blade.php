...
@section('htmlheader_title')
	Jutemillproductionlineinventory View
@endsection
...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $jutemillproductionlineinventory->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/jutemillproductionlineinventories/'.$jutemillproductionlineinventory->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jutemillproductionlineinventories.destroy', $jutemillproductionlineinventory->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/jutemillproductionlineinventories') }}" data-toggle="tooltip" data-placement="right" title="Back to Jutemillproductionlineinventories"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'stock_in_store')
						@la_display($module, 'stock_from')
						@la_display($module, 'parent_id')
						@la_display($module, 'isProcessJute')
						@la_display($module, 'process_jute')
						@la_display($module, 'process_quantity')
						@la_display($module, 'process_sub_unit_quantity')
						@la_display($module, 'process_total_quantity')
						@la_display($module, 'process_stock_in_store')
						@la_display($module, 'isInStock')
