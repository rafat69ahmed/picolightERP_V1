...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $bankdiposit->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/bankdiposits/'.$bankdiposit->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.bankdiposits.destroy', $bankdiposit->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/bankdiposits') }}" data-toggle="tooltip" data-placement="right" title="Back to BankDiposits"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'diposit_no')
						@la_display($module, 'bank_account_id')
						@la_display($module, 'diposit_date')
						@la_display($module, 'diposit_type')
						@la_display($module, 'diposited_branch')
						@la_display($module, 'diposited_by')
						@la_display($module, 'tranjection_reference_no')
						@la_display($module, 'diposit_from')
						@la_display($module, 'cheque_no')
						@la_display($module, 'amount')
						@la_display($module, 'grand_total')
