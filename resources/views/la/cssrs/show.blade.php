...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cssr->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/cssrs/'.$cssr->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cssrs.destroy', $cssr->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cssrs') }}" data-toggle="tooltip" data-placement="right" title="Back to CsSRs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'booking_no')
						@la_display($module, 'date')
						@la_display($module, 'party')
						@la_display($module, 'agent')
						@la_display($module, 'potato_type')
						@la_display($module, 'empty_sacks')
						@la_display($module, 'transportation_free_cose')
						@la_display($module, 'other_cost')
						@la_display($module, 'others_cost_details')
