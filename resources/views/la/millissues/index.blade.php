...
@section("contentheader_title", "MillIssues")
@section("contentheader_description", "millissues listing")
@section("section", "MillIssues")
@section("sub_section", "Listing")
@section("htmlheader_title", "MillIssues Listing")

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add MillIssue</button>
@endsection
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Mill Issue</h4>
			</div>
			{!! Form::open(['action' => 'LA\MillIssuesController@store', 'id' => 'millissue-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/millissue_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
