...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $acctransactionmaster->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/acctransactionmasters/'.$acctransactionmaster->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.acctransactionmasters.destroy', $acctransactionmaster->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/acctransactionmasters') }}" data-toggle="tooltip" data-placement="right" title="Back to AccTransactionMasters"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'trans_ma_id')
						@la_display($module, 'trans_date')
						@la_display($module, 'voucher_no')
						@la_display($module, 'voucher_payee')
						@la_display($module, 'method_ref_id')
						@la_display($module, 'method_ref_no')
						@la_display($module, 'trans_description')
						@la_display($module, 'approved_by')
						@la_display($module, 'approved_date')
						@la_display($module, 'modified_date')
						@la_display($module, 'module')
						@la_display($module, 'company_id')
						@la_display($module, 'user_id')
						@la_display($module, 'voucher_type')
						@la_display($module, 'trans_method_id')
					</div>
				</div>
			</div>
		</div>
