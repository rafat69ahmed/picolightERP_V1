...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $jmproductionlineissue->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/jmproductionlineissues/'.$jmproductionlineissue->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jmproductionlineissues.destroy', $jmproductionlineissue->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/jmproductionlineissues') }}" data-toggle="tooltip" data-placement="right" title="Back to JMProductionLineIssues"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'jute_process_type')
						@la_display($module, 'proguction_line_id')
						@la_display($module, 'unit_type')
						@la_display($module, 'sub_unit_type')
						@la_display($module, 'in_hand_q')
						@la_display($module, 'total_quantity')
						@la_display($module, 'total_sub_unit_quantity')
						@la_display($module, 'pacca_q')
						@la_display($module, 'total_pacca_q')
						@la_display($module, 'kacha_q')
						@la_display($module, 'total_Kacha_q')
						@la_display($module, 'Cut_q')
						@la_display($module, 'total_cut_q')
						@la_display($module, 'Stock')
