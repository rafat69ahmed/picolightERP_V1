...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $csdeed->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/csdeeds/'.$csdeed->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.csdeeds.destroy', $csdeed->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/csdeeds') }}" data-toggle="tooltip" data-placement="right" title="Back to CsDeeds"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'deed_no')
						@la_display($module, 'date')
						@la_display($module, 'party')
						@la_display($module, 'sr_no')
						@la_display($module, 'quantity')
						@la_display($module, 'empty_sacks')
						@la_display($module, 'rent_per_sacks')
						@la_display($module, 'empty_sacks_price')
						@la_display($module, 'total_rent')
						@la_display($module, 'total_empty_sacks_price')
