...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $csloan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/csloans/'.$csloan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.csloans.destroy', $csloan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/csloans') }}" data-toggle="tooltip" data-placement="right" title="Back to CsLoans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'loan_no')
						@la_display($module, 'date')
						@la_display($module, 'party')
						@la_display($module, 'party_deed')
						@la_display($module, 'sr_no')
						@la_display($module, 'loan_type')
						@la_display($module, 'loan_amount')
						@la_display($module, 'max_loan_amount')
						@la_display($module, 'Toatal_loan_amount')
						@la_display($module, 'party_previous_loan_amount')
						@la_display($module, 'total_liabilities')
						@la_display($module, 'user_id')
						@la_display($module, 'status')
						@la_display($module, 'loan_received')
					</div>
				</div>
			</div>
		</div>
