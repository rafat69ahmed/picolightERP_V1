...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $jmloomproduction->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/jmloomproductions/'.$jmloomproduction->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.jmloomproductions.destroy', $jmloomproduction->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/jmloomproductions') }}" data-toggle="tooltip" data-placement="right" title="Back to JMLoomProductions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'serial')
						@la_display($module, 'date')
						@la_display($module, 'item')
						@la_display($module, 'category')
						<!-- @la_display($module, 'calc_max_production')
						@la_display($module, 'terget_parcent')
						@la_display($module, 'achivet_parcent_Piece')
						@la_display($module, 'achivet_parcent') -->
						@la_display($module, 'terget_q_piece')
						@la_display($module, 'terget_q')
						@la_display($module, 'unit_type')
						@la_display($module, 'sun_unit_type')
						@la_display($module, 'production_quantity_Piece')
						@la_display($module, 'production_quantity')
						@la_display($module, 'total_production_quantity_Piec')
						@la_display($module, 'total_production_quantity')
						@la_display($module, 'total_achivet_parcent_piece')
						@la_display($module, 'total_achivet_parcent')
