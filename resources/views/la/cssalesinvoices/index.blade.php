...
@section("contentheader_title", "CsSalesInvoices")
@section("contentheader_description", "cssalesinvoices listing")
@section("section", "CsSalesInvoices")
@section("sub_section", "Listing")
@section("htmlheader_title", "CsSalesInvoices Listing")

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add CsSalesInvoice</button>
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add CsSalesInvoice</h4>
			</div>
			{!! Form::open(['action' => 'LA\CsSalesInvoicesController@store', 'id' => 'cssalesinvoice-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/cssalesinvoice_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#cssalesinvoice-add-form").validate({
