...
class CreateLedgerreportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("LedgerReports", 'ledgerreports', 'author','ALL',[
    ...
    {
        if (Schema::hasTable('ledgerreports')) {
            Schema::drop('ledgerreports');
        }
    }
}
