...
class CreateBankpledgesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("BankPledges", 'bankpledges', 'bankpledge_no', 'JM',[
            ["bankpledge_no",       "Pledge No",         "Name",     false, "",  0,  256,  true],
            ["date_pledge", "Date", "Date", false,    "date('Y-m-d')", 0, 0,   false],
            ...
            ["jute_receive_id",   "Jute Receive List",    "Dropdown", true, 0,           0,  0,      true, "@jutereceives"],
            ["jute_receive",  "Jute Receive List",   "Multiselect", false, [2,3],    0,  0,      false, "@jutereceives"],
            ...
            ["pledge_status",  "Bank Paedge Status",       "Radio",    false, "Instore", 0,  0,      false, ["Instore","Returned"]],
            ["returned_date", "Returned Date", "Date", false,    "date('Y-m-d')", 0, 0,   false],
    ...
    {
        if (Schema::hasTable('bankpledges')) {
            Schema::drop('bankpledges');
        }
    }
}
