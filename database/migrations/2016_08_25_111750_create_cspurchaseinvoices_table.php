...
class CreateCspurchaseinvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsPurchaseInvoices", 'cspurchaseinvoices', 'category', 'CS', [
        ["invoice_no",        "Invoice No",         "Name",     false, "",  0,  256,    true],
        ["date", "Date", "Date", false, "date('Y-m-d')", 0, 0,   false],

        // ["invoice_no",        "Invoice No",         "Name",     false, "",  0,  256,    false],

        ["bill_no",        "Bill No",         "Name",     false, "",  0,  256,    true],
        ["purchase_type",   "Purchase Type",    "Dropdown", false, "Direct",    0,  0,      false, ["Direct","Purchase Order"]],
        ["suppliers",   "suppliers",    "Dropdown", false, 0,           0,  0,      true, "@cssuppliers"],
        ...
        ["Purchase_price",       "Purchase Price",        "Currency", false, 0.0,         0,  0,      true],
        ["total_Purchase_price",       "Total Purchase Price",        "Currency", false, 0.0,         0,  0,      true],
    ...
    {
        if (Schema::hasTable('cspurchaseinvoices')) {
            Schema::drop('cspurchaseinvoices');
        }
    }
}
