...
class CreateCssuppliersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("CsSuppliers", 'cssuppliers', 'supplier_code', 'CS',[
        ["supplier_code",        "Supplier Code",         "Name",     false, "",  3,  256,    false],
        ...
        ["details",     "Details",      "Textarea",  false, "",          0,  1000,   false],
    ...
    {
        if (Schema::hasTable('cssuppliers')) {
            Schema::drop('cssuppliers');
        }
    }
}
