...
class CreateCssubunittypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsSubUnitTypes", 'cssubunittypes', 'sub_unit', 'CS',[
            ["unit",   "Unit",    "Dropdown", false, 0,           0,  0,      true, "@csunittypes"],
            ["sub_unit",        "Sub Unit",         "Name",     false, "",  5,  256,    false],
            ["value",      "Value",       "Decimal",  false, 0.0,         0,  20,     false],
    ...
    {
        if (Schema::hasTable('cssubunittypes')) {
            Schema::drop('cssubunittypes');
        }
    }
}
