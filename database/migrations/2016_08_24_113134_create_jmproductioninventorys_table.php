...
class CreateJmproductioninventorysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
    Module::generate("JMProductionInventorys", 'jmproductioninventorys', 'item', 'JM',[
    ["date", "Date", "Date", false, "date('Y-m-d')", 0, 0,   false],
    ["item",   "Item",    "Dropdown", false, 0,           0,  0,      false, "@jmproductionitems"],
    ["categorys",   "Categorys",    "Dropdown", false, 0,           0,  0,      false, "@jmproductionitemcategorys"],
    ["unit_type",   "Unit Ttype",    "Dropdown", false, 0,           0,  0,      false, "@jutemillsubunittypes"],
    ["production_quantity",      "Quantity",       "Float",    false, 0.0,         0,  20.00,  false],
    ["production_sub_quantity",      "Sub Unit Quantity",       "Float",    false, 0.0,         0,  20.00,  false],
    ["distribution",      "Status",       "Radio",    false, "Not Distribute", 0,  0,      false, ["Not Distribute","Deleverd","Store"]],
    ...
    {
        if (Schema::hasTable('jmproductioninventorys')) {
            Schema::drop('jmproductioninventorys');
        }
    }
}
