...
class CreateCsdeedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsDeeds", 'csdeeds', 'deed_no', 'CS',[
        ["deed_no",        "deed No",         "Name",     false, "",  0,  256,    true],
        ...
        ["rent_per_sacks",       "Rent Per Sacks",        "Currency", false, 0.0,         0,  0,      false],
        ["empty_sacks_price",       "Empty Sacks Price",        "Currency", false, 0.0,         0,  0,      false],
        ["total_rent",       "Total Rent",        "Currency", false, 0.0,         0,  0,      false],
        ["total_empty_sacks_price",       "Total Empty Sacks Price",        "Currency", false, 0.0,         0,  0,      false],
        ...
        ["status",      "Loan status",       "Radio",    false, "No Loan", 0,  0,      false, ["Loan","Loan Paid", "No Loan"]],
