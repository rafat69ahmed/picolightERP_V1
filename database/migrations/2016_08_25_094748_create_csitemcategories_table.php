...
class CreateCsitemcategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsItemCategories", 'csitemcategories', 'category', 'CS',[
            ["item",   "Items",    "Dropdown", false, 0,           0,  0,      true, "@csitems"],
            ["category",        "Category",         "Name",     false, "",  5,  256,    false],
    ...
    {
        if (Schema::hasTable('csitemcategories')) {
            Schema::drop('csitemcategories');
        }
    }
}
