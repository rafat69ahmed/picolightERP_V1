...
class CreateCsdistributionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsDistributions", 'csdistributions', 'distribution_no', 'CS',[
        ["distribution_no",        "Distribution No",         "Name",     false, "",  0,  256,    true],
        ["date", "Date", "Date", false, "date('Y-m-d')", 0, 0,   false],
        ["party",   "Party",    "Dropdown", false, 0,           0,  0,      false, "@cspartys"],
        ["deeds",   "Deed",    "Dropdown", false, 0,           0,  0,      false, "@csdeeds"],
        ["sr",   "SR",    "Dropdown", false, 0,           0,  0,      false, "@cssrs"],
        ["distribute_quantity",      "Distribute Quantity",       "Float",    false, 0.0,         0,  20.00,  false],
        ["tatal_payment",       "Total Amount",        "Currency", false, 0.0,         0,  0,      false],
        ["per_sacks_payment_amt",       "Per Sacks Liabilities",        "Currency", false, 0.0,         0,  0,      false],
        ["paid_amount",       "Paid",        "Currency", false, 0.0,         0,  0,      false],
    ...
    {
        if (Schema::hasTable('csdistributions')) {
            Schema::drop('csdistributions');
        }
    }
}
