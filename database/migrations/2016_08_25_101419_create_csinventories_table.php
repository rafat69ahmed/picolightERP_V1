...
class CreateCsinventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsInventories", 'csinventories', 'category', 'CS',[
        ...
        ["inhand_quantity",      "Available Quantity",       "Float",    false, 0.0,         0,  20.00,  false],
        ["inhand_sub_quantity",      "Available Sub Quantity",       "Float",    false, 0.0,         0,  20.00,  false],
        ["stock_status",      "Stock Status",       "Radio",    false, "Available", 0,  0,      false, ["Available","Out Of Stock"]],
    ...
    {
        if (Schema::hasTable('csinventories')) {
            Schema::drop('csinventories');
        }
    }
}
