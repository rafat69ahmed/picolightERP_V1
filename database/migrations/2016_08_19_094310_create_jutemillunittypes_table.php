...
class CreateJutemillunittypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Jute mill Unit Types", 'jutemillunittypes', 'unit_type_title',  'JM',[
            ["unit_type_title",        "Unit Title",         "Name",     false, "",  0,  256,    true],
    ...
    {
        if (Schema::hasTable('jutemillunittypes')) {
            Schema::drop('jutemillunittypes');
        }
    }
}
