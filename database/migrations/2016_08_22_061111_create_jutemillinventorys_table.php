...
class CreateJutemillinventorysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Jute mill inventorys", 'jutemillinventorys', 'code', 'JM',[
            ["code",       "Code",         "Name",     false, "",  0,  256,  true],
            ...
            ["stock_from",  "Stock Receive From",       "Radio",    false, "", 0,  0,      false, ["Jute Receive","Bank Pledge Returned" ,"Purchase" ]],
    ...
    {
        if (Schema::hasTable('jutemillinventorys')) {
            Schema::drop('jutemillinventorys');
        }
    }
}
