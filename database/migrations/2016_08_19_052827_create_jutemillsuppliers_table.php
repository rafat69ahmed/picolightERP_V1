...
class CreateJutemillsuppliersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Jute mill suppliers", 'jutemillsuppliers', 'name',  'JM',[
        ["name",            "Name",             "Name",     false, "",          3,  256,    true],
        ["code",            "Code",             "Name",     false, "",          3,  256,    false],
        ["address",         "Address",          "Address",  false, "",          0,  1000,   true],
        ["mobile",          "Mobile No",        "Mobile",   false, "+88",       10,  20,     false],
        ...
        $suppliers = Array
        (
            Array('name' => 'Md Karim','code' => '001'),
            Array('name' => 'Md amin','code' => '002')
        );
       
        foreach ($suppliers as $value) {
            $row = new Jutemillsupplier;
            $row->name = $value['name'];
            $row->code = $value['code'];
            $row->save();
            };
    ...
    {
        if (Schema::hasTable('jutemillsuppliers')) {
            Schema::drop('jutemillsuppliers');
        }
    }
}
