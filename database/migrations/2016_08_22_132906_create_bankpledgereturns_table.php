...
class CreateBankpledgereturnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("BankPledgeReturns", 'bankpledgereturns', 'bankpledge_return_no', 'JM',[
            ["bankpledge_return_no",       "Pledge No",         "Name",     false, "",  0,  256,  true],
            ...
            ["date_pledge_return", "Date", "Date", false,    "date('Y-m-d')", 0, 0,   false],

            ["jute_receive_id",   "Jute Receive List",    "Dropdown", true, 0,           0,  0,      true, "@bankpledges"],
            ["jute_receive",  "Jute Receive List",   "Multiselect", false, [2,3],    0,  0,      false, "@bankpledges"],
            ...
            ["stock_in_bankPledge",      "Available",       "Float",    false, 0.0,         0,  20.00,  true],
 
            ["pledge_status",  "Bank Paedge Status",       "Radio",    false, "Returned", 0,  0,      false, ["Instore","Returned"]],
    ...
    {
        if (Schema::hasTable('bankpledgereturns')) {
            Schema::drop('bankpledgereturns');
        }
    }
}
