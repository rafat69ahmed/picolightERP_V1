...
class CreateJutereceivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Jute Receives", 'jutereceives', 'jute_receive_no', 'JM',[
            ["jute_receive_no",       "Receive No",         "Name",     false, "",  0,  256,  true],
            ["date_receive_jute", "Date", "Date", false,    "date('Y-m-d')", 0, 0,   false],
            ["supplier_id",   "Supplier",    "Dropdown", false, 0,           0,  0,      true, "@jutemillsuppliers"],
            ["item_id",   "Item",    "Dropdown", false, 0,           0,  0,      true, "@jutemillitems"],
            ["itemcategorie_id",   "Categorie",    "Dropdown", false, 0,           0,  0,      true, "@jutemillitemcategories"],
            ["item_categorie",  "Categorie",   "Multiselect", false, [2,3],    0,  0,      false, "@jutemillitemcategories"],
            ...
            ["is_bank_paedge",      "Bank Paedge Status",       "Radio",    false, "Not pledged", 0,  0,      false, ["Not pledged","pledged"]],
            ["is_bill_paid",      "Bill Status",       "Radio",    false, "Due", 0,  0,      false, ["Due","Paid"]],
    ...
    {
        if (Schema::hasTable('jutereceives')) {
            Schema::drop('jutereceives');
        }
    }
}
