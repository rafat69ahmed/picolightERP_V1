...
class CreateCsunittypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsUnitTypes", 'csunittypes', 'unit', 'CS',[
            ["unit",        "Unit",         "Name",     false, "",  5,  256,    false],
            ["value",      "Value",       "Decimal",  false, 1.0,         0,  20,     true],
            ["detail",        "Detail",         "Name",     false, "",  5,  256,    true],
    ...
    {
        if (Schema::hasTable('csunittypes')) {
            Schema::drop('csunittypes');
        }
    }
}
