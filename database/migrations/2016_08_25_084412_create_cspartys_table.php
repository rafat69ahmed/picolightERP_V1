...
class CreateCspartysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsPartys", 'cspartys', 'party_code', 'CS',[
            ["party_Type",   "Party Type",    "Dropdown", false, "Grower",    0,  0,      false, ["Merchandiser","Grower"]],
            ["party_code",        "Party Code",         "Name",     false, "",  5,  256,    false],
            ["name",        "Name",         "Name",     false, "",  5,  256,    true],
            ["fathers_name",        "Father",         "Name",     false, "",  5,  256,    false],
            ["address",     "Address",      "Address",  false, "",          0,  1000,   false],
            ["mobile",      "Mobile",       "Mobile",   false, "+88", 0, 20, false],
            
            ["liability",       "Liability",        "Currency", false, 0.0,         0,  0,      false],
            ["emptySacks",       "Empty Sacks",        "Integer",  false, 0,           0,  5000,   false],
    ...
    {
        if (Schema::hasTable('cspartys')) {
            Schema::drop('cspartys');
        }
    }
}
