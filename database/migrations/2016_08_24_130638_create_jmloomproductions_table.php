...
class CreateJmloomproductionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
    Module::generate("JMLoomProductions", 'jmloomproductions', 'category', 'JM',[
    ...
    ["category",   "Item Category",    "Dropdown", false, 0,           0,  0,      false, "@jmproduceitemcategorys"],
    
    // ["calc_max_production",      "Max. Production",       "Float",    false, 0.0,         0,  20.00,  false],
    // ["terget_parcent",      "Terget (%)",       "Float",    false, 0.0,         0,  20.00,  false],
    // ["achivet_parcent_Piece",      "Piece Achive(%)",       "Float",    false, 0.0,         0,  20.00,  false],
    // ["achivet_parcent",      "KG Achive(%)",       "Float",    false, 0.0,         0,  20.00,  false],
    
    ["terget_q_piece",      "Terget (Piece)",       "Float",    false, 0.0,         0,  20.00,  false],
    ["terget_q",      "Terget (Kg)",       "Float",    false, 0.0,         0,  20.00,  false],
    ...
    ["production_quantity_Piece",      "Achive (Piece)",       "Float",    false, 0.0,         0,  20.00,  false],
    ["production_quantity",      "Achive (KG)",       "Float",    false, 0.0,         0,  20.00,  false],
    
    ["total_production_quantity_Piece",      "Total (Piece)",       "Float",    false, 0.0,         0,  20.00,  false],
    ["total_production_quantity",      "Achive (KG)",       "Float",    false, 0.0,         0,  20.00,  false],
    ["total_achivet_parcent_piece",      "Total Achive Piece(%)",       "Float",    false, 0.0,         0,  20.00,  false],
    ...
    {
        if (Schema::hasTable('jmloomproductions')) {
            Schema::drop('jmloomproductions');
        }
    }
}
