...
class CreateAcctransactiondetailsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("AccTransactionDetails", 'acctransactiondetails', 'trans_d_id', 'ALL',[
            ["trans_d_id",       "Detail Id",        "Integer",  false, 0,           0,  5000,   false],
            ["trans_m_id",        "Master Id",        "Dropdown", false, 3,           0,  0,      false, "@acc_transaction_masters"],
            ["account_id",        "Account Id",        "String", false, "",           0,  0,      false],
            ["credit_amt",        "Credit Amount",       "Decimal",  false, 0.0,         0,  20,     true],
            ["debit_amt",        "Debit Amount",       "Decimal",  false, 0.0,         0,  20,     true],
            ["comments",            "Comments",           "String",   false, "",          0, 256,   true],
    ...
    {
        if (Schema::hasTable('acctransactiondetails')) {
            Schema::drop('acctransactiondetails');
        }
    }
}
