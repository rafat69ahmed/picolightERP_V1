...
class CreateCssackmanagementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsSackManagements", 'cssackmanagements', 'category', 'CS',[
        ["distribution_no",        "Distribution No",         "Name",     false, "",  0,  256,    false],
        ...
        ["store_list",   "List",    "Dropdown", false, 0,           0,  0,      true, "@csinventories"],
        ["party",   "Party",    "Dropdown", false, 0,           0,  0,      true, "@cspartys"],
        ["quantity",       "Quantity",        "Integer",  false, 0,           0,  5000,   false],
        ["return_date", "Return Date", "Date", false, "date('Y-m-d')", 0, 0,   false],
        ["returned",       "Returned",        "Integer",  false, 0,           0,  5000,   false],
    ...
    {
        if (Schema::hasTable('cssackmanagements')) {
            Schema::drop('cssackmanagements');
        }
    }
}
