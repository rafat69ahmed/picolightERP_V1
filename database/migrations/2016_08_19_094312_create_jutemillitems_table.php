...
class CreateJutemillitemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Jute Mill Items", 'jutemillitems', 'item_name',  'JM',[
            ["item_name",        "Item",         "Name",     false, "",  0,  256,    true],
            ["item_code",        "Code",         "Name",     false, "",  0,  256,    true],
            ["item_discription", "Discription",  "Address",  false, "",  0,  1000,   false],
        ...
        $suppliers = Array
        (
            Array('item_name' => 'Jute','item_code' => '001'),
            Array('item_name' => 'Oil','item_code' => '002'),
            
        );
       
        foreach ($suppliers as $value) {
            $row = new Jutemillitem;
    ...
    {
        if (Schema::hasTable('jutemillitems')) {
            Schema::drop('jutemillitems');
        }
    }
}
