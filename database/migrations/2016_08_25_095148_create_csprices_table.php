...
class CreateCspricesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("CsPrices", 'csprices', 'category', 'CS',[
        ["item",   "Items",    "Dropdown", false, 0,           0,  0,      true, "@csitems"],
        ["category",   "Category",    "Dropdown", false, 0,           0,  0,      true, "@csitemcategories"],
        ["purchase_price",       "Purchase Price",        "Currency", false, 0.0,         0,  0,      false],
        ["selling_price",       "Selling Price",        "Currency", false, 0.0,         0,  0,      false],
        ["unit_status",      "Unit Status",       "Radio",    false, "Unit", 0,  0,      false, ["Unit","Sub Unit"]],
    ...
    {
        if (Schema::hasTable('csprices')) {
            Schema::drop('csprices');
        }
    }
}
