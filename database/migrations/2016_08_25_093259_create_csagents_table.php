...
class CreateCsagentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("CsAgents", 'csagents', 'agent_code', 'CS',[
            ["agent_code",        "Agent Code",         "Name",     false, "",  5,  256,    false],
    ...
    {
        if (Schema::hasTable('csagents')) {
            Schema::drop('csagents');
        }
    }
}
