...
class CreateAccVoucherTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Acc_voucher_types", 'acc_voucher_types', 'voucher_type_id', 'ALL',[
            ["voucher_type_id",         "voucher Type Id",          "Integer",  false,                  0, 0,  5000,   false],
            ["voucher_type",            "Voucher Type",             "String",   false, "",              0, 256,        true],
    ...
    {
        if (Schema::hasTable('acc_voucher_types')) {
            Schema::drop('acc_voucher_types');
        }
    }
}
